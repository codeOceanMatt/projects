...
public class UserSqlDAO implements UserDAO {
	...
	public List<User> findAllButMe(int id) {
		Long userId = new Long(id);
		 List<User> users = new ArrayList<>();
	        ...
	        while(results.next()) {
	            User user = mapRowToUserLite(results);
	            users.add(user);
	        }
	        return users;   
	}
    ...
    public String findNameById(int id) {
    	...
    	SqlRowSet results = jdbcTemplate.queryForRowSet(getName, id);
    	while(results.next()) {
    	nameReturned = results.getString("username");
    	}
    	return nameReturned;
    }
...
///\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\||||||||||||||||||||////////////////////////////////////////////////////////////////////////////////
    ...
    private User mapRowToUser(SqlRowSet rs) {
	 ...
	 private User mapRowToUserLite(SqlRowSet rs) {
